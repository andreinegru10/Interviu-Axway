...
public class Graph {
	...
	public boolean hasVertex(String label) { return adjVertices.containsKey(new Vertex(label)); }
	...
	public Map<Vertex, List<Vertex>> getAdjList() { return adjVertices; }
